    ...
    <div className="min-h-screen">
      ...
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-[250px] border-r border-white/[.065] bg-black/68 p-5 backdrop-blur-xl lg:flex lg:flex-col">
        <div className="flex items-center gap-3 px-2 pt-1">
          <div className="grid h-10 w-10 place-items-center rounded-2xl border border-[#d946ef]/35 bg-gradient-to-br from-[#d946ef]/25 via-[#6d28d9]/10 to-transparent shadow-[0_0_35px_rgba(139,92,246,.18)]">
          ...
          {nav.map((item) => {
            ...
            return (
              <Link key={item.href} href={item.href} className={"group relative flex items-center gap-3 overflow-hidden rounded-xl px-3 py-2.5 text-sm transition " + classes}>
                {active && <span className="absolute inset-y-2 left-0 w-[2px] rounded-full bg-[#f472d0] shadow-[0_0_14px_rgba(155,108,255,.9)]" />}<Icon size={17} className={active ? "text-[#f5d0fe]" : ""} />
        ...
        <div className="mt-8 border-t border-white/[.06] pt-6">
          ...
          <button className="group flex w-full items-center justify-between rounded-xl border transition hover:-translate-y-0.5 hover:shadow-[0_0_32px_rgba(139,92,246,.12)] border-[#d946ef]/20 bg-[#d946ef]/[.06] px-3 py-3 text-sm text-[#f5d0fe]">
        ...
        <div className="mt-auto rounded-2xl border border-white/[.065] bg-white/[.025] p-3.5">
          <div className="flex items-center gap-3">
            <div className="grid h-9 w-9 place-items-center rounded-full bg-gradient-to-br from-[#c026d3] to-[#f0abfc] text-xs font-bold">NG</div>
      ...
      <div className="relative lg:pl-[250px]">
        <header className="sticky top-0 z-30 flex h-[70px] items-center justify-between border-b border-white/[.055] bg-[#030306]/74 px-4 backdrop-blur-xl sm:px-7 lg:px-9">
          <div className="flex items-center gap-3 lg:hidden">
            <div className="grid h-9 w-9 place-items-center rounded-xl border border-[#d946ef]/30 bg-[#d946ef]/10"><Command size={17} /></div>
          ...
          <div className="flex items-center gap-2">
            <button className="relative rounded-xl border border-white/[.065] bg-white/[.025] p-2.5 text-[#788399]"><Bell size={17} /><span className="absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-[#d946ef]" /></button>
